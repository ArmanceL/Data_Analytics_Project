...
- *grain_screened* : do not favour screened grain (more "no_band" without)
...
```
We see no correlation between variables so there are independant variables except *ink_pct* & *varnish_pct*, which are negatively correlated.
