...
```
Out of the 540 observations in the database, we now have 467, without missing values. We can now proceed with our analysis. 
...
```
Then the second table is the confusion matrix of the random forest model on the test set. We now have an accuracy of 0,7435897.
